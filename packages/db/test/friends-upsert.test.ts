...
describe('upsertFriend', () => {
  it('persists a first-contact sender with an account-scoped LINE identity', async () => {
  ...
  it('updates the persisted winner when a duplicate account/user already exists', async () => {
    const sqlite = createFriendsDb();
    sqlite.prepare(`
      INSERT INTO friends
